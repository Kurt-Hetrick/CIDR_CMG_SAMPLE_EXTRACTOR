...
cp -rvf $CORE_PATH/M_Valle_MendelianDisorders_SeqWholeExome_120511_PLAYGROUND/$FAMILY"_ANNOVAR"/$SM_TAG"_MS_OnBait.vcf" \
$CORE_PATH/M_Valle_MendelianDisorders_SeqWholeExome_120511_PLAYGROUND/TEMP/$SM_TAG/$SM_TAG"_MS_OnBait.vcf"
